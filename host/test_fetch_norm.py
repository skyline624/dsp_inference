...
# 1. Charge w[64] dans SDRAM via LL
# 2. Envoie FN : sx sw x[64] addr[3] -> FPGA fetche w depuis SDRAM, run rmsnorm
...
def main():
    ...
    # 1. Charge w dans SDRAM a l'addresse 0x000800
    sdram_addr = 0x000800
    ...
    print("  load OK")
    # Verif : relire w depuis SDRAM via CC, comparer
    ...
    # 3. Run FN (fetche w depuis SDRAM)
