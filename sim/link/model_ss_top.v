`timescale 1ns/1ps
// =============================================================================
// model_ss_top - MULTI-LAYER forward pass (NL layers of attn+FFN) over NN nodes
// on the parallel ss_link. Same shared-fifo mux as layer_ss_top, plus the layer
// loop of model_tp_top. NN=1 mono-card autonomous multi-layer inference.
// =============================================================================
module model_ss_top #(
    parameter W = 8,
    parameter D = 64,
    ...
    input  wire [NL*8-1:0] sw_rms_a, swq, swk, swv, swo,
    input  wire [NL*8-1:0] sw_rms_f, sw1, sw3, sw2,
